# Local Clerk Webhooks for User Sync

Use a public tunnel to deliver Clerk webhooks to your local Next.js dev server to test user creation, update, and deletion events.
...
## Verify
- Use Clerk’s “Send test event” for `user.created` or perform actions in your app (like creating or updating a user's name).
