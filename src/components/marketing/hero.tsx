              ...
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                <AnimatedGroup variants={transitionVariants}>
                  ...
                  <p
                    ...
                    Autenticação (Clerk), PostgreSQL + Prisma, pagamentos (Asaas) e sistema de créditos — com UI em Tailwind + Radix. Lance mais rápido com TypeScript do frontend ao backend.
                  </p>
                </AnimatedGroup>
